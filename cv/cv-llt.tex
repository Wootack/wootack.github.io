...
\PassOptionsToPackage{style=ieee,sorting=ydnt,uniquename=init,defernumbers=true,backend=bibtex}{biblatex}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Wootack Kim, Ph.D. Student}

  \makefield{\faEnvelope[regular]}{\href{mailto:wootack.kim@hcs.snu.ac.kr}{\texttt{wootack.kim@hcs.snu.ac.kr}}}
  ...
  % \makefield{\faTwitter}{\!\href{https://x.com/overleaf_example}{\texttt{@overleaf\_example}}}
  \makefield{\faLinkedin}
  {\href{http://www.linkedin.com/in/wootack-kim-90973a289/}{\texttt{Wootack Kim}}}

  %% Next line
  \makefield{\faGlobe}{\url{https://wootack.github.io/}}
